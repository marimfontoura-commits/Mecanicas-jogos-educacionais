...
export const MECHANICS: Mechanic[] = [
  {
    id: 'creative-writing',
    title: 'Redação Criativa: Storybook',
    description: 'Crie sua própria história ilustrando cenas com emojis e escrevendo os atos da narrativa.',
    type: MechanicType.CREATIVE,
    discipline: Discipline.PORTUGUES,
    segments: [Segment.AI],
    years: ['2º ano', '3º ano', '4º ano', '5º ano'],
  ...
  {
    id: 'science-trophic',
    title: 'Cadeia Alimentar: Fluxo Energético',
    description: 'Posicione os organismos nos níveis tróficos corretos para completar o fluxo de energia. Inclui animação de fluxo e validação biológica.',
    type: MechanicType.SEQUENCE,
    discipline: Discipline.CIENCIAS,
    segments: [Segment.AI, Segment.AF],
